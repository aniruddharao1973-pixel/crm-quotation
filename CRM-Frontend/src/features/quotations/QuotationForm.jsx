            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
                ...
                <div className="relative overflow-hidden border-b border-slate-100 px-6 py-5">
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-50/80 via-white to-white" />
                  <div className="relative">
                    <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-lg bg-amber-100">
                      <svg
                ...
                <div className="bg-slate-50/50 p-5">
                  <textarea
                    ...
                    onChange={(e) => updateField("notes", e.target.value)}
                    placeholder="Add notes for this quotation..."
                    className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm outline-none transition-all placeholder:text-slate-300 focus:border-indigo-300 focus:ring-4 focus:ring-indigo-500/10 resize-none"
                  />
                </div>
              </div>
